...
// Función para convertir un valor de color entero en una estructura de color
...
// Función para establecer el color de la pluma
static void ngc_setColor(Color newColor){
    penColor = newColor;
}

// Función para imprimir una cadena con un color específico
void ngc_printColor(const char * string, uint64_t colorInt){
    Color color;
    colorIntToColor(colorInt, &color);
    ngc_setColor(color);
    ngc_print(string);
    Color white = {0xFF, 0xFF, 0xFF}; //reset to default print color
    ngc_setColor(white);
}
...
// Función para imprimir un carácter en la pantalla (tamaño de fuente 1)
...
// Función para imprimir un carácter en la pantalla (tamaño de fuente 2)
...
// Función para imprimir un carácter en la pantalla (tamaño de fuente 3)
...
// Función para imprimir un carácter en la pantalla
...
// Función para imprimir una nueva línea en la pantalla
void ngc_printNewline(void) {
    lastPenX = penX;
    penX = 0; // A la izquierda
...
// Función para imprimir un píxel en la pantalla
...
// Función para imprimir píxeles en la pantalla
...
// Función para pintar toda la pantalla con un color de fondo
...
// Función para eliminar el último carácter impreso en la pantalla
static void delete_last_char() {
    if (penX == CHAR_WIDTH*2*level) 
    {
        return;
    }
    else {
